...
var CoreService = /** @class */ (function () {
    ...
    CoreService.prototype.getClients = function () {
        var _this = this;
        var url = "" + this.clientsEndpoint;
        this.observable = this.http.get(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            _this.observable = null;
            _this.clients = new _app_models_clients_model__WEBPACK_IMPORTED_MODULE_5__["Clients"](response);
            return _this.clients;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) { return _this.handleError(error); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["share"])());
        return this.observable;
    };
    //Get Scout Missions
    CoreService.prototype.getScoutMissions = function () {
        var _this = this;
        var url = "" + this.scoutMissionEndpoint;
        this.observable = this.http.get(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            _this.observable = null;
            _this.scoutMissions = new _app_models_scoutMissions_module__WEBPACK_IMPORTED_MODULE_6__["ScoutMissions"](response);
            return _this.scoutMissions;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) { return _this.handleError(error); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["share"])());
        return this.observable;
    };
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(coreService, activatedRoute, _http, changeDetectorRefs) {
    ...
    DashboardComponent.prototype.setClients = function () {
        var _this = this;
        this.clients = [];
        this.coreService.getClients().subscribe(function (response) {
            _this.clients = response.data.results;
            console.log(_this.clients);
            setTimeout(function () {
                jQuery('select').material_select();
            }, 200);
        }, function (err) {
            console.log('Error fetching clients' + _this.clients);
        });
    };
    DashboardComponent.prototype.setScoutMissions = function () {
        var _this = this;
        this.scoutMissions = [];
        this.coreService.getScoutMissions().subscribe(function (res) {
            _this.scoutMissions = res.data.results;
            console.log(_this.scoutMissions);
        }, function (err) {
            console.log('Error fetching Scout Missions' + _this.scoutMissions);
        });
    };
    DashboardComponent.prototype.onSelectedClientChange = function (val) {
        debugger;
        // this.selectedClient.push(i);
        console.log(val);
    };
    DashboardComponent.prototype.selectedScoutMissions = function (missionID, workerID, i) {
        debugger;
        // this.selectedClient.push(i);
        console.log(i);
    };
...
var Clients = /** @class */ (function () {
    function Clients(json) {
        this.data = [];
        this.data = json;
    }
    Clients.ctorParameters = function () { return [
        null
    ]; };
    return Clients;
}());
...
var ScoutMissions = /** @class */ (function () {
    function ScoutMissions(json) {
        this.data = [];
        this.data = json;
    }
    ScoutMissions.ctorParameters = function () { return [
        null
    ]; };
